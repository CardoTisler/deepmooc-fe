<script lang="ts">
	...
	const { topic, tags, title, deadlineTime, deadlineDate } = data;
</script>

<div class="flex flex-col bg-gray-100 rounded-xl h-36 p-2 border-gray-200 border-2 w-full">
	...
	<div class="flex flex-row w-full justify-between pt-3">
		...
		<div class="flex items-center">
			<button class="btn-accent rounded-sm px-2 py-1 flex flex-row"
				>Lahenda<span class="pl-2"><RightArrow /></span></button
			>
		</div>
	</div>
</div>
